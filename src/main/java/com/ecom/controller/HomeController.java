...
public class HomeController {
   ...
   private FileService fileService;
	...
	//	m.addAttribute("products",products);
		...
		{
			page =  productService.getAllActiveProductPagenation(pageNo, pageSize,category);
		}else {
	...
	//Generate URL : http://localhost:8080/reset-passsword?token=jkakkvdvbjvjvjvk
	
	 String url = CommonUtil.generateUrl(request)+"/reset-passsword?token="+resetToken; 
